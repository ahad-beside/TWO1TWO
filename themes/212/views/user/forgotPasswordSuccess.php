...
<div class="login-text">
  ...
  <p>You have successfully changed you password.</p>
<!--  <p>If you have ANY questions about the operation of this online shop, please email the store owner.</p>-->
   <a style="border:1px solid #FFF;" class="btn btn-sm btn-primary" href="<?= Yii::app()->homeUrl ?>">Home</a>
    <a style="border:1px solid #FFF;" class="btn btn-sm btn-primary" href="<?php echo yii::app()->createUrl('//site/login');?>">Login</a>
</div>
</div>
</div>
      </div>
