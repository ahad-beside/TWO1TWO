      ...
      <div class="col-md-9 col-sm-9 col-xs-12">
        <div class="shop-content">
          <div class="perrow">
                <div class="row">
                <div class="col-md-12">
                  <h2><span>Order# <?=$order->order_number?></span><span style="float: right;">Status: <?=$order->status?></span></h2>
                  <hr>
    <div class="row">
      <div class="row">
    <div class="col-md-12">
                ...
                <div class="">
                    ...
                    <div class="panel-body order_view_title" style="padding:0px;">
                        <table class="table checkout-table gu12" style="margin-bottom:0px; border:none;">
                            ...
                            <tbody>
                                    ...
                                    if (count($regular) > 0) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="price" style="text-align: right; border-bottom:1px solid #ddd;"><?php echo $regularOrder->qty; ?></td>
                            ...
                            <tfoot>
                                <tr>
                                    <th align="right" style="text-align:right; border:none;" colspan="3" class="price">&nbsp;</th>
                                    <th align="right" style="text-align:right; border-left:1px solid #ddd; border-right:1px solid #ddd;" class="price">Total:</th>
                                    <th style="text-align: right; border-left:1px solid #ddd; border-right:1px solid #ddd;" class="price grandTotal"><?= Yii::app()->params->usdCurrency . number_format($order->total, Yii::app()->params->decimalPoint) ?></th>
                                </tr>
                                <?php if ($order->vat > 0): ?>
                                    <tr>
                                        <th align="right" style="text-align:right; border:none;" colspan="3" class="price">&nbsp;</th>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: right; font-size:24px; border-bottom:1px solid #ddd; border-right:1px solid #ddd;" class="price grandTotal"><?= Yii::app()->params->usdCurrency.number_format($order->grand_total, Yii::app()->params->decimalPoint) ?></th>
                                </tr> 
