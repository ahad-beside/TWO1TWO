...
! function(a) {
    ...
    b.DEFAULTS = {
        initOnClick: !1,
        pluginsEnabled: null
    }, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.4.0", b.INSTANCES = [], b.OPTS_MAPPING = {}, b.SHARED = {}, b.ID = 0, b.prototype._init = function() {
        ...
        function t() {
            return null == x && (x = navigator.platform.toUpperCase().indexOf("MAC") >= 0), x
        }
        ...
        function u() {
            ...
            try {
                ...
                var e = /^\s*:scope/gi;
                a(HTMLElement.prototype, "querySelector"), a(HTMLElement.prototype, "querySelectorAll")
            }
        }
        ...
        function u(a, b) {
            return a instanceof jQuery && (a = a.get(0)), a && a.classList && a.classList.contains(b)
        }
        ...
        function p(a) {
            ...
            } else b.doc.selection && "Control" != b.doc.selection.type && (c = b.doc.selection.createRange(), d = c.duplicate(), d.moveToElementText(a), d.setEndPoint("EndToStart", c),
                e = "" === d.text, d.moveToElementText(a), d.setEndPoint("StartToEnd", c), f = "" === d.text);
            return {
                atStart: e,
                atEnd: f
            }
        ...
        function d(a, d) {
            if ("undefined" != typeof a && a || (a = b.el), "undefined" == typeof d && (d = !1), !a.getAttribute || "false" != a.getAttribute("contenteditable"))
        ...
        function d(c) {
            var d = [],
                e = [];
            if (c)
                for (var g = b.el.querySelectorAll(".fr-marker"), h = 0; h < g.length; h++) {
            ...
            for (var h = e.length - 1; h >= 0; h--)
                if (!(e[h].textContent && e[h].textContent.replace(/\u200B|\n/g, "").length > 0 || e[h].querySelectorAll(l).length > 0)) {
                    for (var m = b.node.contents(e[h]), n = !1, o = 0; o < m.length; o++)
        ...
        function h(a, d) {
            ...
            if (d && (e = "div"), e) {
                for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild; i;) {
                    ...
                    else if ("BR" == i.tagName) j && "BR" == j.tagName && (j = j.nextSibling), null == g ? (g = b.doc.createElement(e), d && g.setAttribute("data-empty", !0), g.appendChild(i), f.appendChild(g)) : h === !1 && (g.appendChild(b.doc.createElement("br")), g.setAttribute("data-empty", !0)), g = null;
                    else {
                        var k = i.textContent;
        ...
        function n(a) {
            ...
            for (var c = b.doc.createTreeWalker(a, NodeFilter.SHOW_TEXT, b.node.filter(function(a) {
                ...
                var d = c.currentNode,
                    e = b.node.isBlock(d.parentNode) || b.node.isElement(d.parentNode),
        ...
        function s() {
            ...
            for (var g = [], h = 0; h < d.length; h++)
                for (var i = d[h].querySelectorAll("br"), j = 0; j < i.length; j++) g.indexOf(i[j]) < 0 && g.push(i[j]);
            if (c.parentNode == b.el)
                for (var k = b.el.children, h = 0; h < k.length; h++) "BR" == k[h].tagName && g.indexOf(k[h]) < 0 && g.push(k[h]);
            return g
        }
        ...
        function u() {
            g(), j(), n(), b.spaces.normalize(null, !0), b.html.fillEmptyBlocks(), b.clean.quotes(), b.clean.lists(), b.clean.tables(), b.clean.toHTML5(), b.html.cleanBRs(), b.selection.restore(), v(), b.placeholder.refresh()
        }
            ...
            if (!b.opts.useClasses && !c) {
                        ...
                        for (var m = 0, n = j.length; m < n; m++)
                            if (j[m].selectorText && j[m].style.cssText.length > 0) {
                                ...
                                for (var r = 0; r < o.length; r++) {
                                    !o[r].getAttribute("fr-original-style") && o[r].getAttribute("style") ? (o[r].setAttribute("fr-original-style", o[r].getAttribute("style")), g.push(o[r])) : o[r].getAttribute("fr-original-style") || g.push(o[r]), h[o[r]] || (h[o[r]] = {});
                                    for (var s = 1e3 * k + f(j[m].selectorText), t = j[m].style.cssText.split(";"), u = 0; u < t.length; u++) {
                                        var v = t[u].trim().split(":")[0];
                                        v.match(i) || (h[o[r]][v] || (h[o[r]][v] = 0, (o[r].getAttribute("fr-original-style") || "").indexOf(v + ":") >= 0 && (h[o[r]][v] = 1e4)), s >= h[o[r]][v] && (h[o[r]][v] = s, t[u].trim().length && (o[r].style[v.trim()] = t[u].trim().split(":")[1].trim())))
                                    }
                                }
                            }
                }
                for (e = 0; e < g.length; e++)
                    if (g[e].getAttribute("class") && (g[e].setAttribute("fr-original-class", g[e].getAttribute("class")), g[e].removeAttribute("class")), (g[e].getAttribute("fr-original-style") || "").trim().length > 0)
                        for (var w = g[e].getAttribute("fr-original-style").split(";"), r = 0; r < w.length; r++) w[r].indexOf(":") > 0 && (g[e].style[w[r].split(":")[0].trim()] = w[r].split(":")[1].trim())
            }
        ...
        function F(a, c, d) {
            b.selection.isCollapsed() || b.selection.remove();
            var e;
            if (e = c ? a : b.clean.html(a), e = e.replace(/\r|\n/g, " "), a.indexOf('class="fr-marker"') < 0 && (e = D(e)), b.core.isEmpty() && !b.opts.keepFormatOnDelete) b.el.innerHTML = e;
            else {
                var f = b.markers.insert();
                if (f) {
                    var g, h = b.node.blockParent(f);
                    if ((C(e) || d) && (g = b.node.deepestParent(f) || h && "LI" == h.tagName)) {
        ...
        function H() {
            var a = function() {
                G(), b.placeholder && b.placeholder.refresh()
            };
        ...
        function j() {
            ...
            return c(j) ? f = i(j) : d(j) ? g(j) && e(j, a(j).parents("li:first").get(0)) ? b.cursorLists._backspace(j) : h(j) : f = i(j), a(j).remove(), n(), b.html.fillEmptyBlocks(!0), b.html.cleanEmptyTags(), b.clean.quotes(), b.clean.lists(), b.spaces.normalizeAroundCursor(), b.selection.restore(), f
        }
        ...
        function m() {
            ...
            a(e).remove(), n(), b.html.fillEmptyBlocks(!0), b.html.cleanEmptyTags(), b.clean.quotes(), b.clean.lists(), b.spaces.normalizeAroundCursor(), b.selection.restore()
        }
        ...
        function s(e) {
            ...
            b.el.normalize();
            var h = !1;
            a(f).parentsUntil(b.$el, "BLOCKQUOTE").length > 0 && (e = !1, h = !0), a(f).parentsUntil(b.$el, "TD, TH").length && (h = !1), c(f) ? !g(f) || e || h ? p(f, e, h) : b.cursorLists._endEnter(f) : d(f) ? !g(f) || e || h ? q(f, e, h) : b.cursorLists._startEnter(f) : !g(f) || e || h ? r(f, e, h) : b.cursorLists._middleEnter(f), o(), b.html.fillEmptyBlocks(!0), b.html.cleanEmptyTags(), b.clean.lists(), b.spaces.normalizeAroundCursor(), b.selection.restore()
        }
        return {
            enter: s,
            backspace: j,
        ...
        function y() {
            if (b.events.on("keydown", u), b.events.on("input", h), b.events.on("keyup input", v), b.events.on("keypress", k), b.events.on("keydown", m), b.events.on("keyup", q), b.events.on("html.inserted", q), b.events.on("cut", i), b.el.msGetInputContext) try {
        ...
        function c(a) {
            a && a.length && (a.data("blur-event-set") || a.parents(".fr-popup").length || (b.events.$on(a, "blur", function(c) {
                var d = a.parents(".fr-toolbar, .fr-popup").data("instance") || b;
                d.events.blurActive() && d.events.trigger("blur"), d.events.enableBlur()
            }, !0), a.data("blur-event-set", !0)), b.events.disableBlur(), a.focus(), b.shared.$f_el = a)
        }
        ...
        function i(a) {
            ...
            c.data("mouseenter-event-set") || (b.events.$on(c, "mouseenter", "[tabIndex]", function(d) {
                ...
                if (!E) return d.stopPropagation(), void d.preventDefault();
                var f = c.find(":focus:first");
                f.length && !f.is("input, button") && (e.events.disableBlur(), f.blur(), e.events.disableBlur(), e.events.focus())
        ...
        function l(e, g, h) {
            if (b.shared.$f_el) {
                ...
                var j = e.find("button:visible:not(.fr-disabled), .fr-group span.fr-command:visible"),
                    l = j.index(b.shared.$f_el);
                if (0 == l && !h || l == j.length - 1 && h) {
                    var m;
                    if (g) {
        ...
        function p() {
            return b.shared.$f_el && b.shared.$f_el.is(".fr-dropdown:not(.fr-active)") ? r() : o(!0)
        }
        ...
        function r() {
            if (b.shared.$f_el) {
                if (b.shared.$f_el.hasClass("fr-dropdown")) b.button.click(b.shared.$f_el);
                    ...
                    a && (b.shared.with_kb = !1), b.button.click(b.shared.$f_el), y(a)
                } else {
        ...
        function s() {
            b.shared.$f_el && (b.events.disableBlur(), b.shared.$f_el.blur(), b.shared.$f_el = null), b.events.disableBlur(), b.events.focus()
        }
        ...
        function u(c, d) {
            var e = navigator.userAgent.indexOf("Mac OS X") != -1 ? c.metaKey : c.ctrlKey,
                f = c.which,
                g = !1;
            return f != a.FE.KEYCODE.TAB || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_RIGHT || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.TAB || e || !c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_LEFT || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_UP || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ARROW_DOWN || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ENTER || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.ESC || e || c.shiftKey || c.altKey ? f != a.FE.KEYCODE.F10 || e || c.shiftKey || !c.altKey || (g = j()) : g = t(d) : g = r() : g = p() : g = q() : g = n(d) : g = n(d, !0) : g = m(d) : g = m(d, !0), b.shared.$f_el || void 0 !== g || (g = !0), !g && b.keys.isBrowserAction(c) && (g = !0), !!g || (c.preventDefault(), c.stopPropagation(), !1)
        }
        ...
        function w(a) {
            var c = b.popups.get(a),
                d = x(a);
            v(c.find(".fr-buttons")), b.events.$on(c, "mouseenter", "tabIndex", d._tiMouseenter, !0), b.events.$on(c.children().not(".fr-buttons"), "keydown", "[tabIndex]", d._tiKeydown, !0), b.popups.onHide(a, function() {
                h(c.data("instance") || b)
        ...
        function C(c) {
            ...
            if (e == a.FE.KEYCODE.F10 && !d && !c.shiftKey && c.altKey) {
                ...
                var g = b.popups.areVisible(b),
                    h = !1;
                return g && (h = f(g.children().not(".fr-buttons"))), h || j(), b.shared.with_kb = !1, c.preventDefault(), c.stopPropagation(), !1
            }
            return !0
        }

        function D() {
            b.$wp ? b.events.on("keydown", C, !0) : b.events.$on(b.$win, "keydown", C, !0), b.events.on("mousedown", function(a) {
                B(b), b.shared.$f_el && (h(b), a.stopPropagation(), b.events.disableBlur(), b.shared.$f_el = null)
            }, !0), b.events.on("blur", function(a) {
                b.shared.$f_el = null, B(b)
            }, !0)
        }
        var E = !0;
        return {
        ...
        function j(c, d, g, h) {
            for (var i = b.node.contents(c.get(0)), k = 0; k < i.length; k++) {
                ...
                }), "undefined" == typeof g && l.nodeType == Node.ELEMENT_NODE && !b.node.isVoid(l) && !b.node.isBlock(l) || f(l, e(g, h)) ? a(l).replaceWith(l.innerHTML) : "undefined" == typeof g && l.nodeType == Node.ELEMENT_NODE && b.node.isBlock(l) && a(l).removeAttr("style")) : a(l).find(".fr-marker").length > 0 && (d = j(a(l), d, g, h))
            }
            return d
        }
        ...
        function h() {
            ...
            if (b.opts.pastePlain && (m = g(m)), d = b.events.chainTrigger("paste.afterCleanup", m), "string" == typeof d && (m = d), "" !== m) {
                ...
                var r = l.children;
                if (1 == r.length && ["OL", "UL"].indexOf(r[0].tagName) && (r[0].outerHTML = r[0].innerHTML), !h)
                    for (var s = l.getElementsByTagName("br"), p = 0; p < s.length; p++) {
                        var t = s[p];
                        b.node.isBlock(t.previousSibling) && t.parentNode.removeChild(t)
                    }
                if (b.opts.enter == a.FE.ENTER_BR)
                    for (var u = l.querySelectorAll("p, div"), p = 0; p < u.length; p++) {
                        var v = u[p];
                        v.outerHTML = v.innerHTML + (v.nextSibling && !b.node.isEmpty(v) ? "<br>" : "")
                    } else if (b.opts.enter == a.FE.ENTER_DIV)
                        for (var u = l.getElementsByTagName("p"), p = 0; p < u.length; p++) {
                            var v = u[p];
        ...
        function j(a) {
            ...
            for (var f = c.querySelectorAll(":scope > div:not([style]), td > div, th > div, li > div"); f.length;) {
                var g = f[f.length - 1];
                if (b.html.defaultTag() && "div" != b.html.defaultTag()) g.outerHTML = "<" + b.html.defaultTag() + ">" + g.innerHTML + "</" + b.html.defaultTag() + ">";
                else {
                    var h = g.querySelector("*:last");
                    h && "BR" == h.tagName ? g.outerHTML = g.innerHTML : g.outerHTML = g.innerHTML + "<br>"
                }
        ...
        function c(c) {
            var d = c.next(),
                e = b.node.hasClass(c.get(0), "fr-active"),
        ...
        function e(c, e, f) {
            if (b.shared.$overlay || (b.shared.$overlay = a('<div class="fr-overlay">').appendTo("body")), m = b.shared.$overlay, b.opts.theme && m.addClass(b.opts.theme + "-theme"), !n[c]) {
                ...
                n[c] = {
                    ...
                    var e = d.which;
                    return e == a.FE.KEYCODE.ESC ? (h(c), b.accessibility.focusModalButton(g), !1) : !(!a(d.currentTarget).is("input[type=text], textarea") && e != a.FE.KEYCODE.ARROW_UP && e != a.FE.KEYCODE.ARROW_DOWN) || (d.preventDefault(), d.stopPropagation(), !1)
                }, !0), h(c)
            }
            return n[c]
        }
        ...
        function g(a) {
            if (n[a]) {
                var c = n[a].$modal;
                c.data("instance", b), c.show(), m.show(), b.$doc.find("body").addClass("prevent-scroll"), b.helpers.isMobile() && b.$doc.find("body").addClass("fr-mobile"), c.addClass("fr-active"), b.core.hasFocus() || (b.events.disableBlur(), b.events.focus()), b.accessibility.saveSelection(), b.events.disableBlur(), b.$el.blur(), b.selection.clear(), b.events.disableBlur(), c.find("[tabIndex]:first").focus()
            }
        }
        ...
        function d(d, e, h, i) {
            if (g() && b.$el.find(".fr-marker").length > 0 ? (b.events.disableBlur(), b.selection.restore()) : (b.events.disableBlur(), b.events.focus()), m([d]), !x[d]) return !1;
            ...
            var k = x[d].outerWidth(),
                l = (x[d].outerHeight(), f(d));
                ...
                _repositionPopup: function(e) {
                    ...
                    if (b.$wp && f(c) && d.parent().get(0) == a(b.opts.scrollableContainer).get(0)) {
                        var g = d.offset().top - b.$wp.offset().top,
                            h = b.$wp.outerHeight();
                        b.node.hasClass(d.get(0), "fr-above") && (g += d.outerHeight()), g > h || g < 0 ? d.addClass("fr-hidden") : d.removeClass("fr-hidden")
                    }
                }
            }
        }
        ...
        function e(c, d) {
            var e = c.outerWidth();
            return d + e > a(b.opts.scrollableContainer).width() - 10 && (d = a(b.opts.scrollableContainer).width() - e - 10), d < 0 && (d = 10), d
        }
        ...
        function j() {
            var a = document.createElement("test"),
                c = a.style;
            return c.cssText = "position:" + ["-webkit-", "-moz-", "-ms-", "-o-", ""].join("sticky; position:") + " sticky;", c.position.indexOf("sticky") !== -1 && !b.helpers.isIOS() && !b.helpers.isAndroid()
        }
        ...
        toolbarButtonsXS: ["bold", "italic", "fontFamily", "fontSize", "|", "undo", "redo", "help"],
        toolbarButtonsSM: ["bold", "italic", "underline", "|", "fontFamily", "fontSize", "insertLink", "insertImage", "table", "|", "undo", "redo", "help"],
        toolbarButtonsMD: ["fullscreen", "bold", "italic", "underline", "fontFamily", "fontSize", "color", "paragraphStyle", "paragraphFormat", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "insertHR", "-", "insertLink", "insertImage", "insertVideo", "insertFile", "insertTable", "undo", "redo", "clearFormatting", "help"],
        ...
        function h(c, d) {
            setTimeout(function() {
                if (c && c.which == a.FE.KEYCODE.ESC);
                    ...
                    b.opts.toolbarContainer || b.position.forSelection(b.$tb), b.opts.zIndex > 1 ? b.$tb.css("z-index", b.opts.zIndex + 1) : b.$tb.css("z-index", null), b.$tb.show()
                }
            }, 0)
        }
        ...
        function k() {
            ...
            }, !0), b.events.$on(b.$wp, "scroll.toolbar", h), b.events.on("commands.after", h), b.helpers.isMobile() && (b.events.$on(b.$doc, "selectionchange", h), b.events.$on(b.$doc, "orientationchange", h))
        }
        ...
        function p() {
            ...
            }, !0), b.opts.toolbarInline = !1) : b.opts.toolbarInline ? (b.$box.addClass("fr-inline"), b.shared.$tb ? (b.$tb = b.shared.$tb, k()) : (b.shared.$tb = a('<div class="fr-toolbar"></div>'), b.$tb = b.shared.$tb, o())) : (b.$box.addClass("fr-basic"), b.$tb = a('<div class="fr-toolbar"></div>'), o(), b.$tb.data("instance", b)), b.events.on("destroy", n, !0), void b.events.on(b.opts.toolbarInline || b.opts.toolbarContainer ? "shared.destroy" : "destroy", m, !0))
        }

        function q() {
            !v && b.$tb && (b.$tb.find("> .fr-command").addClass("fr-disabled fr-no-refresh").attr("aria-disabled", !0), v = !0)
        }

        function r() {
            v && b.$tb && (b.$tb.find("> .fr-command").removeClass("fr-disabled fr-no-refresh").attr("aria-disabled", !1), v = !1), b.button.bulkRefresh()
        }
        var s, t, u = [];
