...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        function c() {
            ...
            c.val(""), sa && c.val(sa.attr("src")), c.trigger("change")
        }
        ...
        function e() {
            ...
            if (c || (c = p()), c) {
                b.popups.setContainer("image.edit", a(b.opts.scrollableContainer)), b.popups.refresh("image.edit");
                var d = sa.offset().left + sa.outerWidth() / 2,
                    e = sa.offset().top + sa.outerHeight();
        ...
        function g(a) {
            if (!a.hasClass("fr-dii") && !a.hasClass("fr-dib")) {
                var c = a.css("float");
                a.css("float", "none"), "block" == a.css("display") ? (a.css("float", c), b.opts.imageEditButtons.indexOf("imageAlign") >= 0 && (0 === parseInt(a.css("margin-left"), 10) && (a.attr("style") || "").indexOf("margin-right: auto") >= 0 ? a.addClass("fr-fil") : 0 === parseInt(a.css("margin-right"), 10) && (a.attr("style") || "").indexOf("margin-left: auto") >= 0 && a.addClass("fr-fir")), a.addClass("fr-dib")) : (a.css("float", c), b.opts.imageEditButtons.indexOf("imageAlign") >= 0 && ("left" == a.css("float") ? a.addClass("fr-fil") : "right" == a.css("float") && a.addClass("fr-fir")), a.addClass("fr-dii")), a.css("margin", ""), a.css("float", ""), a.css("display", ""), a.css("z-index", ""), a.css("position", ""), a.css("overflow", ""), a.css("vertical-align", "")
            }
        }
        ...
        function h() {
            for (var c = "IMG" == b.el.tagName ? [b.el] : b.el.querySelectorAll("img"), d = 0; d < c.length; d++) {
                var e = a(c[d]);
                (b.opts.imageEditButtons.indexOf("imageAlign") >= 0 || b.opts.imageEditButtons.indexOf("imageDisplay") >= 0) && g(e), b.opts.imageTextNear || e.removeClass("fr-dii").addClass("fr-dib"), b.opts.iframe && e.on("load", b.size.syncIframe)
            }
        }
        ...
        function i() {
            ...
            if (Fa)
                for (c = 0; c < Fa.length; c++) e.indexOf(Fa[c].getAttribute("src")) < 0 && b.events.trigger("image.removed", [a(Fa[c])]);
            Fa = d
        }
        ...
        function l(c) {
            if (!b.core.sameInstance(ta)) return !0;
            if (c.preventDefault(), c.stopPropagation(), b.$el.find("img.fr-error").left) return !1;
            b.undo.canDo() || b.undo.saveStep(), ua = a(this), ua.data("start-x", c.pageX || c.originalEvent.touches[0].pageX), ua.data("start-width", sa.width()), ua.data("start-height", sa.height());
            var d = sa.width();
            if (b.opts.imageResizeWithPercent) {
                var e = sa.parentsUntil(b.$el, b.html.blockTagsQuery()).get(0) || b.el;
                sa.css("width", (d / a(e).outerWidth() * 100).toFixed(2) + "%")
            } else sa.css("width", d);
            va.show(), b.popups.hideAll(), ga()
        }
        ...
        function m(c) {
            ...
            if (ua && sa) {
                ...
                if (!d) return !1;
                var e = ua.data("start-x"),
                    f = d - e,
                    g = ua.data("start-width");
                if ((ua.hasClass("fr-hnw") || ua.hasClass("fr-hsw")) && (f = 0 - f), b.opts.imageResizeWithPercent) {
                    var h = sa.parentsUntil(b.$el, b.html.blockTagsQuery()).get(0) || b.el;
                    g = ((g + f) / a(h).outerWidth() * 100).toFixed(2), b.opts.imageRoundPercent && (g = Math.round(g)), sa.css("width", g + "%"), sa.css("height", "").removeAttr("height")
                } else g + f >= b.opts.imageMinWidth && sa.css("width", g + f), sa.css("height", ua.data("start-height") * sa.width() / ua.data("start-width"));
                j(), b.events.trigger("image.resize", [qa()])
            }
        }
        ...
        function n(a) {
            ...
            if (ua && sa) {
                ...
                ua = null, va.hide(), j(), e(), b.undo.saveStep(), b.events.trigger("image.resizeEnd", [qa()])
            }
        }

        function o(a, c) {
            b.edit.on(), sa && sa.addClass("fr-error"), t(b.language.translate("Something went wrong. Please try again.")), b.events.trigger("image.error", [{
                code: a,
                message: Ea[a]
            }, c])
        }
        ...
        function p(a) {
            if (a) return b.$wp && b.events.$on(b.$wp, "scroll", function() {
                sa && b.popups.isVisible("image.edit") && e()
            }), !0;
            var c = "";
        ...
        function q(c) {
            ...
            if (d || (d = L()), d.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), d.find(".fr-image-progress-bar-layer").addClass("fr-active"), d.find(".fr-buttons").hide(), sa) {
                b.popups.setContainer("image.insert", a(b.opts.scrollableContainer));
                var e = sa.offset().left + sa.width() / 2,
                    f = sa.offset().top + sa.height();
                b.popups.show("image.insert", e, f, sa.outerHeight())
            }
        ...
        function r(a) {
            ...
            if (c && (c.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), c.find(".fr-image-progress-bar-layer").removeClass("fr-active"), c.find(".fr-buttons").show(), a || b.$el.find("img.fr-error").length)) {
                if (b.events.focus(), b.$el.find("img.fr-error").length && (b.$el.find("img.fr-error").remove(), b.undo.saveStep(), b.undo.run(), b.undo.dropRedo()), !b.$wp && sa) {
                    var d = sa;
                    ea(!0), b.selection.setAfter(d.get(0)), b.selection.restore()
                }
        ...
        function u() {
            var a = b.popups.get("image.insert"),
                c = a.find(".fr-image-by-url-layer input");
            c.val().length > 0 && (q(), s("Loading image"), x(c.val(), !0, [], sa), c.val(""), c.blur())
        }
        ...
        function w() {
            var c = a(this);
            b.popups.hide("image.insert"), c.removeClass("fr-uploading"), c.next().is("br") && c.next().remove(), v(c), b.events.trigger("image.loaded", [c])
        }
        ...
        function x(a, c, d, e, f) {
            ...
            g.onload = function() {
                ...
                if (e) {
                    ...
                    c.on("load", w), c.attr("src", a), b.edit.on(), i(), b.undo.saveStep(), b.$el.blur(), b.events.trigger(h ? "image.replaced" : "image.inserted", [c, f])
                } else c = D(a, d, w), i(), b.undo.saveStep(), b.events.trigger("image.inserted", [c, f])
            }, g.onerror = function() {
                o(xa)
            }, q("Loading image"), g.src = a
        }
        ...
        function B() {
            o(Aa, this.response || this.responseText || this.responseXML)
        }
        ...
        function D(c, d, e) {
            ...
            i.on("load", e), b.edit.on(), b.events.focus(!0), b.selection.restore(), b.undo.saveStep(), b.opts.imageSplitHTML ? b.markers.split() : b.markers.insert();
        ...
        function F(c, d, e) {
            function f() {
                var e = a(this);
                e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), b.placeholder.refresh(), e.is(sa) || v(e), j(), q(), b.edit.off(), c.onload = function() {
                    A.call(c, e)
                }, c.onerror = B, c.upload.onprogress = C, c.onabort = E, e.off("abortUpload").on("abortUpload", function() {
            ...
            h.addEventListener("load", function() {
                ...
                sa ? (sa.on("load", f), b.edit.on(), b.undo.saveStep(), sa.data("fr-old-src", sa.attr("src")), sa.attr("src", a)) : g = D(a, null, f)
            }, !1), h.readAsDataURL(e)
        }
        ...
        function G(a) {
            if ("undefined" != typeof a && a.length > 0) {
                ...
                var c = a[0];
                if (c.size > b.opts.imageMaxSize) return o(Ba), !1;
                if (b.opts.imageAllowedTypes.indexOf(c.type.replace(/image\//g, "")) < 0) return o(Ca), !1;
                var d;
        ...
        function I(c) {
            ...
            if (d && d.files && d.files.length) {
                ...
                if (e && e.type && b.opts.imageAllowedTypes.indexOf(e.type.replace(/image\//g, "")) >= 0) {
                    ...
                    return f || (f = L()), b.popups.setContainer("image.insert", a(b.opts.scrollableContainer)), b.popups.show("image.insert", c.originalEvent.pageX, c.originalEvent.pageY), q(), G(d.files), c.preventDefault(), c.stopPropagation(), !1
                }
            }
        }
        ...
        function K() {
            b.events.$on(b.$el, b._mousedown, "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function(c) {
                return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable") || (b.helpers.isMobile() || b.selection.clear(), wa = !0, b.popups.areVisible() && b.events.disableBlur(), b.browser.msie && (b.events.disableBlur(), b.$el.attr("contenteditable", !1)), b.draggable || c.preventDefault(), void c.stopPropagation())
            }), b.events.$on(b.$el, b._mouseup, "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function(c) {
                return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(body):first").attr("contenteditable") || void(wa && (wa = !1, c.stopPropagation(), b.browser.msie && (b.$el.attr("contenteditable", !0), b.events.enableBlur())))
            ...
            }, !0), b.events.on("drop", I), b.events.on("mousedown window.mousedown", fa), b.events.on("window.touchmove", ga), b.events.on("mouseup window.mouseup", function() {
                if (sa) return ea(), !1
            }), b.events.on("commands.mousedown", function(a) {
                a.parents(".fr-toolbar").length > 0 && ea()
            }), b.events.on("mouseup", J), b.events.on("blur image.hideResizer commands.undo commands.redo element.dropped", function() {
                wa = !1, ea(!0)
            })
        }
        ...
        function L(a) {
            ...
            return b.$wp && b.events.$on(b.$wp, "scroll", function() {
                sa && b.popups.isVisible("image.insert") && na()
            }), H(m), m
        }
        ...
        function M() {
            if (sa) {
                ...
                a.find("input").val(sa.attr("alt") || "").trigger("change")
            }
        }

        function N() {
            var c = b.popups.get("image.alt");
            c || (c = O()), r(), b.popups.refresh("image.alt"), b.popups.setContainer("image.alt", a(b.opts.scrollableContainer));
            var d = sa.offset().left + sa.width() / 2,
                e = sa.offset().top + sa.height();
            b.popups.show("image.alt", d, e, sa.outerHeight())
        }
        ...
        function O(a) {
            ...
            return b.$wp && b.events.$on(b.$wp, "scroll.image-alt", function() {
                sa && b.popups.isVisible("image.alt") && N()
            }), f
        }
        ...
        function P(a) {
            if (sa) {
                var c = b.popups.get("image.alt");
                sa.attr("alt", a || c.find("input").val() || ""), c.find("input:focus").blur(), v(sa)
            }
        }
        ...
        function Q() {
            if (sa) {
                ...
                a.find('input[name="width"]').val(sa.get(0).style.width).trigger("change"), a.find('input[name="height"]').val(sa.get(0).style.height).trigger("change")
            }
        }

        function R() {
            var c = b.popups.get("image.size");
            c || (c = S()), r(), b.popups.refresh("image.size"), b.popups.setContainer("image.size", a(b.opts.scrollableContainer));
            var d = sa.offset().left + sa.width() / 2,
                e = sa.offset().top + sa.height();
            b.popups.show("image.size", d, e, sa.outerHeight())
        }
        ...
        function S(a) {
            ...
            return b.$wp && b.events.$on(b.$wp, "scroll.image-size", function() {
                sa && b.popups.isVisible("image.size") && R()
            }), f
        }
        ...
        function T(a, c) {
            if (sa) {
                ...
                sa.css("width", a || d.find('input[name="width"]').val()), sa.css("height", c || d.find('input[name="height"]').val()), d.find("input:focus").blur(), v(sa)
            }
        }

        function U(a) {
            var c, d, e = b.popups.get("image.insert");
            if (sa || b.opts.toolbarInline) sa && (d = sa.offset().top + sa.outerHeight());
            else {
            ...
            }!sa && b.opts.toolbarInline && (d = e.offset().top - b.helpers.getPX(e.css("margin-top")), e.hasClass("fr-above") && (d += e.outerHeight())), e.find(".fr-layer").removeClass("fr-active"), e.find(".fr-" + a + "-layer").addClass("fr-active"), b.popups.show("image.insert", c, d, sa ? sa.outerHeight() : 0), b.accessibility.focusPopup(e)
        }
        ...
        function X(a, b, c, d) {
            return a.pageX = b, l.call(this, a), a.pageX = a.pageX + c * Math.floor(Math.pow(1.1, d)), m.call(this, a), n.call(this, a), d++
        }

        function Y() {
            var c;
            if (b.shared.$image_resizer ? (ta = b.shared.$image_resizer, va = b.shared.$img_overlay, b.events.on("destroy", function() {
                    ta.removeClass("fr-active").appendTo(a("body"))
                }, !0)) : (b.shared.$image_resizer = a('<div class="fr-image-resizer"></div>'), ta = b.shared.$image_resizer, b.events.$on(ta, "mousedown", function(a) {
                    a.stopPropagation()
                }, !0), b.opts.imageResize && (ta.append(k("nw") + k("ne") + k("sw") + k("se")), b.shared.$img_overlay = a('<div class="fr-image-overlay"></div>'), va = b.shared.$img_overlay, c = ta.get(0).ownerDocument, a(c).find("body").append(va))), b.events.on("shared.destroy", function() {
                    ta.html("").removeData().remove(), ta = null, b.opts.imageResize && (va.remove(), va = null)
                }, !0), b.helpers.isMobile() || b.events.$on(a(b.o_win), "resize", function() {
                    sa && !sa.hasClass("fr-uploading") ? ea(!0) : sa && (j(), na(), q(!1))
                }), b.opts.imageResize) {
                c = ta.get(0).ownerDocument, b.events.$on(ta, b._mousedown, ".fr-handler", l), b.events.$on(a(c), b._mousemove, m), b.events.$on(a(c.defaultView || c.parentWindow), b._mouseup, n), b.events.$on(va, "mouseleave", n);
                var d = 1,
                    e = null,
                    f = 0;
                b.events.on("keydown", function(c) {
                    if (sa) {
                        var g = navigator.userAgent.indexOf("Mac OS X") != -1 ? c.metaKey : c.ctrlKey,
                            h = c.which;
                        (h !== e || c.timeStamp - f > 200) && (d = 1), (h == a.FE.KEYCODE.EQUALS || b.browser.mozilla && h == a.FE.KEYCODE.FF_EQUALS) && g && !c.altKey ? d = X.call(this, c, 1, 1, d) : (h == a.FE.KEYCODE.HYPHEN || b.browser.mozilla && h == a.FE.KEYCODE.FF_HYPHEN) && g && !c.altKey && (d = X.call(this, c, 2, -1, d)), e = h, f = c.timeStamp
                    }
        ...
        function Z(c) {
            c = c || sa, c && b.events.trigger("image.beforeRemove", [c]) !== !1 && (b.popups.hideAll(), oa(), ea(!0), b.undo.canDo() || b.undo.saveStep(), c.get(0) == b.el ? c.removeAttr("src") : ("A" == c.get(0).parentNode.tagName ? (b.selection.setBefore(c.get(0).parentNode) || b.selection.setAfter(c.get(0).parentNode) || c.parent().after(a.FE.MARKERS), a(c.get(0).parentNode).remove()) : (b.selection.setBefore(c.get(0)) || b.selection.setAfter(c.get(0)) || c.after(a.FE.MARKERS), c.remove()), b.html.fillEmptyBlocks(), b.selection.restore()), b.undo.saveStep())
        }

        function $(c) {
            var d = c.which;
            if (sa && (d == a.FE.KEYCODE.BACKSPACE || d == a.FE.KEYCODE.DELETE)) return c.preventDefault(), c.stopPropagation(), Z(), !1;
            if (sa && d == a.FE.KEYCODE.ESC) {
                var e = sa;
                return ea(!0), b.selection.setAfter(e.get(0)), b.selection.restore(), c.preventDefault(), !1
            }
            if (sa && (d == a.FE.KEYCODE.ARROW_LEFT || d == a.FE.KEYCODE.ARROW_RIGHT)) {
                var f = sa.get(0);
                return ea(!0), d == a.FE.KEYCODE.ARROW_LEFT ? b.selection.setBefore(f) : b.selection.setAfter(f), b.selection.restore(), c.preventDefault(), !1
            }
            return sa && d != a.FE.KEYCODE.F10 && !b.keys.isBrowserAction(c) ? (c.preventDefault(), !1) : void 0
        }

        function _() {
            if (K(), "IMG" == b.el.tagName && b.$el.addClass("fr-view"), b.events.$on(b.$el, b.helpers.isMobile() && !b.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', da), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "IMG" == b.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                    Ga = !1
                }), b.events.$on(b.$el, "touchmove", function() {
                    Ga = !0
                })), b.$wp ? b.events.on("window.keydown keydown", $, !0) : b.events.$on(b.$win, "keydown", $), b.events.on("toolbar.esc", function() {
                    if (sa) {
                        if (b.$wp) b.events.disableBlur(), b.events.focus();
                        else {
                            var a = sa;
                            ea(!0), b.selection.setAfter(a.get(0)), b.selection.restore()
                        }
                        return !1
                    }
                }, !0), b.events.on("window.cut window.copy", function(c) {
                    sa && (oa(), a.FE.copied_text = "\n", a.FE.copied_html = sa.get(0).outerHTML, "copy" == c.type ? setTimeout(function() {
                        v(sa)
                    }) : (ea(!0), b.undo.saveStep(), setTimeout(function() {
                        b.undo.saveStep()
                    }, 0)))
                }, !0), b.events.$on(a(b.o_win), "keydown", function(b) {
                    var c = b.which;
                    if (sa && c == a.FE.KEYCODE.BACKSPACE) return b.preventDefault(), !1
                }), b.events.$on(b.$win, "keydown", function(b) {
                    var c = b.which;
                    sa && sa.hasClass("fr-uploading") && c == a.FE.KEYCODE.ESC && sa.trigger("abortUpload")
                }), b.events.on("destroy", function() {
                    sa && sa.hasClass("fr-uploading") && sa.trigger("abortUpload")
                }), b.events.on("paste.before", ba), b.events.on("paste.beforeCleanup", ca), b.events.on("paste.after", aa), b.events.on("html.set", h), b.events.on("html.inserted", h), h(), b.events.on("destroy", function() {
                    Fa = []
            ...
            b.opts.iframe && b.events.on("image.loaded", b.size.syncIframe), b.$wp && (i(), b.events.on("contentChanged", i)), b.events.$on(a(b.o_win), "orientationchange.image", function() {
                setTimeout(function() {
                    var a = qa();
                    a && v(a)
                }, 0)
            }), p(!0), L(!0), S(!0), O(!0), b.events.on("node.remove", function(a) {
        ...
        function da(c) {
            ...
            b.toolbar.disable(), c && (c.stopPropagation(), c.preventDefault()), b.helpers.isMobile() && (b.events.disableBlur(), b.$el.blur(), b.events.enableBlur()), b.opts.iframe && b.size.syncIframe(), sa = a(this), oa(), j(), e(), b.selection.clear(), b.button.bulkRefresh(), b.events.trigger("video.hideResizer")
        }

        function ea(a) {
            sa && (ha() || a === !0) && (b.toolbar.enable(), ta.removeClass("fr-active"), b.popups.hide("image.edit"), sa = null, ga())
        }
        ...
        function ia(a) {
            sa.removeClass("fr-fir fr-fil"), "left" == a ? sa.addClass("fr-fil") : "right" == a && sa.addClass("fr-fir"), j(), e()
        }

        function ja(a) {
            sa && (sa.hasClass("fr-fil") ? a.find("> *:first").replaceWith(b.icon.create("align-left")) : sa.hasClass("fr-fir") ? a.find("> *:first").replaceWith(b.icon.create("align-right")) : a.find("> *:first").replaceWith(b.icon.create("align-justify")))
        }

        function ka(a, b) {
            if (sa) {
                var c = "justify";
                sa.hasClass("fr-fil") ? c = "left" : sa.hasClass("fr-fir") && (c = "right"), b.find('.fr-command[data-param1="' + c + '"]').addClass("fr-active").attr("aria-selected", !0)
            }
        }

        function la(a) {
            sa.removeClass("fr-dii fr-dib"), "inline" == a ? sa.addClass("fr-dii") : "block" == a && sa.addClass("fr-dib"), j(), e()
        }

        function ma(a, b) {
            var c = "block";
            sa.hasClass("fr-dii") && (c = "inline"), b.find('.fr-command[data-param1="' + c + '"]').addClass("fr-active").attr("aria-selected", !0)
        }

        function na() {
            var c = b.popups.get("image.insert");
            c || (c = L()), b.popups.isVisible("image.insert") || (r(), b.popups.refresh("image.insert"), b.popups.setContainer("image.insert", a(b.opts.scrollableContainer)));
            var d = sa.offset().left + sa.width() / 2,
                e = sa.offset().top + sa.height();
            b.popups.show("image.insert", d, e, sa.outerHeight())
        }
        ...
        function pa() {
            sa ? (b.events.disableBlur(), a(".fr-popup input:focus").blur(), v(sa)) : (b.events.disableBlur(), b.selection.restore(), b.events.enableBlur(), b.popups.hide("image.insert"), b.toolbar.showInline())
        }
        ...
        function ra(a, c, d) {
            if ("undefined" == typeof c && (c = b.opts.imageStyles), "undefined" == typeof d && (d = b.opts.imageMultipleStyles), !sa) return !1;
            if (!d) {
                var e = Object.keys(c);
                e.splice(e.indexOf(a), 1), sa.removeClass(e.join(" "))
            }
            sa.toggleClass(a), v(sa)
        }
        var sa, ta, ua, va, wa = !1,
            ...
            Da = 7,
            Ea = {};
        Ea[xa] = "Image cannot be loaded from the passed link.", Ea[ya] = "No link in upload response.", Ea[za] = "Error during file upload.", Ea[Aa] = "Parsing response failed.", Ea[Ba] = "File is too large.", Ea[Ca] = "Image file type is invalid.", Ea[Da] = "Files can be uploaded only to same domain in IE 8 and IE 9.";
        var Fa, Ga, Ha = !1;
        return {
            _init: _,
            showInsertPopup: d,
            ...
            align: ia,
            refreshAlign: ja,
            refreshAlignOnShow: ka,
            display: la,
            refreshDisplayOnShow: ma,
            replace: na,
            back: pa,
            get: qa,
            insert: x,
        ...
        html: function() {
            ...
            for (var d in c) c.hasOwnProperty(d) && (b += '<li role="presentation"><a class="fr-command fr-title" tabIndex="-1" role="option" data-cmd="imageAlign" data-param1="' + d + '" title="' + this.language.translate(c[d]) + '">' + this.icon.create("align-" + d) + '<span class="fr-sr-only">' + this.language.translate(c[d]) + "</span></a></li>");
            return b += "</ul>"
        },
        callback: function(a, b) {
            this.image.align(b)
        ...
        html: function() {
            ...
            for (var c in b) b.hasOwnProperty(c) && (a += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="imageStyle" data-param1="' + c + '">' + this.language.translate(b[c]) + "</a></li>");
            return a += "</ul>"
        },
        callback: function(a, b) {
