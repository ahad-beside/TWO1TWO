...
Filename	: ExportXLS.php
Description	: A light weight PHP class allow to the creation of simple xls spreadsheets from array data.
Version 	: 1.00
Author 		: Nisanth Thulasi
Website		: http://nisanthyii.blogspot.in/
*/
/*
Change Log
V1 - First Release
