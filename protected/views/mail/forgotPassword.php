                                 ...
                                 <table width="100%" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                       <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:bold 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                         You received this email because you filled out a form on <?= Yii::app()->name;?> indicating that you had forgotten your password.
                                       </td>
                                    </tr>
                            ...
                            <table style="margin:0 auto;" width="232" cellspacing="0" cellpadding="0" align="center">
                              <tbody><tr>
                                <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="20" class="btn" style="font:bold 16px/18px Arial, Helvetica, sans-serif; color:#f9f9f9; text-transform:uppercase; mso-padding-alt:22px 10px; border-radius:3px;" bgcolor="#7bb84f" align="center">
                                  <a target="_blank" style="text-decoration:none; color:#f9f9f9; display:block; padding:22px 10px;" href="<?php echo Yii::app()->params->SITE_URL.Yii::app()->createUrl('//user/forgotPassword',array('link'=>$email))?>">Recover Password</a>
                                </td>
                              </tr>
                            </tbody></table>
                          </td>
                                    ...
                                    <tr>
                                       <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="center" style="font:Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                         If a new window doesn't open automatically please copy the URL below and paste it in your browser to manually complete the process. <br /><br />
     
     <a href="<?php echo Yii::app()->params->SITE_URL.Yii::app()->createUrl('//user/forgotPassword',array('link'=>$email))?>" target="_blank"><?php echo Yii::app()->params->SITE_URL.Yii::app()->createUrl('//user/forgotPassword',array('link'=>$email))?></a>
                                       </td>
                                    </tr>
                                 </table>
                              </td>
