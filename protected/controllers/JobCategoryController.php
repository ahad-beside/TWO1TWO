...
class JobCategoryController extends Controller {
    ...
    public function actionView($name) {
        ...
        $catInfo = JobCategory::model()->find('slug=:slug',array(':slug'=>$name));
        if(count($catInfo)>0){
            $id = $catInfo->id;
        ...
        $data['jobList'] = JobList::model()->getProductList($data['q'],$id);//Get Products List
    ...
    public function actionAll() {
        $this->pageTitle =  'All Jobs - '.Yii::app()->name;
        $data['categoryName'] = 'All Jobs';
        ...
        $data['jobList'] = JobList::model()->getAllProductList($data['q'],$data['category_id']);//Get Products List
