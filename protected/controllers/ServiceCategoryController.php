...
class ServiceCategoryController extends Controller {
    ...
    public function actionView($name) {
        ...
        $catInfo = ServiceCategory::model()->find('slug=:slug',array(':slug'=>$name));
        if(count($catInfo)>0){
            $id = $catInfo->id;
        ...
        $data['products'] = Service::model()->getProductList($id, $filter, $sortval, $data['q'],$offset);//Get Products List
    ...
    public function actionAll() {
        $this->pageTitle =  'All Service - '.Yii::app()->name;
        $data['categoryName'] = 'All Service';
        ...
        $data['products'] = Service::model()->getAllProductList($filter, $sortval, $data['q'],$offset,$data['category_id']);//Get Products List
