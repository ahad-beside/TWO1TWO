        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="#" id="billing-entry-form">
                    <input type="hidden" name="BillingInfo[user_id_fk]" class="customerIdInput" value="<?= $data['order']->user_id_fk?>">
                    <p class="note">Fields with <span class="required">*</span> are required.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary create-billing">Create</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="#" id="shipping-entry-form">
                    <input type="hidden" name="ShippingInfo[user_id_fk]" class="customerIdInput" value="<?= $data['order']->user_id_fk?>">
                    <p class="note">Fields with <span class="required">*</span> are required.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
        ...
        if(typeof custId !='undefined' && parseInt(custId)>0){
            $.post('<?= $this->createUrl('getBillingNShipping')?>',{custId: custId},function(data){
                ...
                if(typeof mode!='undefined' && mode=='update'){
                    $('select[name="billing_id"]').val('<?= $data['billingId']?>');
                    $('select[name="shipping_id"]').val('<?= $data['shippingId']?>')
                }
