                            ...
                            <div class="panel-body row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="order_number"><?php echo $on = Order::model()->genOrderNumber('UC'); ?></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="currency">
                                            ...
                                            foreach ($getCurrency as $cr):
                                                echo '<option value="' . strtolower($cr->label) . '">' . $cr->label . '</option>';
                                            endforeach;
                                            ?>
                                        </select>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bilshipload">
                            ...
                            <div class="panel-body billshiploadhere">
                                ...
                                <!-- Billing Shipping Information load here -->
                            </div>
                            <!-- /.panel-body -->
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="bankName">
                                ...
                                foreach ($getBank as $production):
                                    echo '<option  value="' . $production->id . '">' . $production->bank_name .'</option>';
                                endforeach;
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="shippingTime">
                                <?php
                                $getShipping = CustomProductionShipping::model()->findAll('status=1 and type="Shipping" group by name order by sort_order');
...
//            }
    ...
    $('body').on("click", "#same_as_bill", function () {
        if ($("#same_as_bill").is(':checked')) {
            ...
            $('select[name="ShippingInfo[state]"]').removeAttr("readonly");
        }
    });
    //$('body').on("click", "#same_as_bill", function () {
    function sameBillAs() {
        if ($("#same_as_bill").is(':checked')) {
            ...
            $('select[name="ShippingInfo[state]"]').val($('select[name="BillingInfo[state]"]').val().trim());
            ...
            $('select[name="ShippingInfo[state]"]').attr("readonly", "readonly");
        } else {
            ...
            $('select[name="ShippingInfo[state]"]').val($('select[name="ShippingInfo[state]"]').attr('data-value'));
        }
    }
    //});
