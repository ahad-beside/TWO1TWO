					...
					<div class="page-head">
						<div class="container">
							...
							<div class="page-action-buttons">
								...
								<a class="btn btn-sm btn-primary" href="<?= $this->createUrl('//admin/eposterCategory/create') ?>" title="Create ePoster Category"> <i class="fa fa-plus"></i> Create ePoster Category</a>
							</div>
