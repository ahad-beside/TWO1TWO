                                    ...
                                    <div class="portlet-body" style="display: block;">
                                        ...
                                        <div class="form-body">
                                            <div class="form-group">
                                                <?php echo $form->labelEx($model, 'event_id', array('class' => 'col-md-3 control-label')); ?>
                                                <div class="col-md-9">
                                                    <?php echo $form->dropDownList($model, 'event_id',CHtml::listData(EposterList::model()->findAll("user_id=".Yii::app()->user->userId),'id','name'),  array('class' => 'form-control','prompt'=>'Select Any','required'=>'required')); ?>
