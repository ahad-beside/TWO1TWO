<div class="btn-group" style="padding-top: 10px;">
        ...
        <ul role="menu" class="dropdown-menu">
            <li>
            <?php
            echo CHtml::ajaxLink("<i class='fa fa-check-square-o'></i> Pending", Yii::app()->createUrl('//admin/eposterList/pending'), array(
                ...
                UIToastr.init("success",data.totalOrders + " ePoster send to pending list successfully.");
            });
            ...
            <li>
                <?php
                echo CHtml::ajaxLink("<i class='fa fa-check-square-o'></i> Confirmed", Yii::app()->createUrl('//admin/eposterList/confirmed'), array(
                    'cache' => true,
                    'type' => 'POST',
                    'data' => 'js:{value : $.fn.yiiGridView.getChecked("job-view-data","actionCheck[]")}',
                    "beforeSend" => 'js:function(){

                                            var ask = confirm("Are you sure want to confirm this ePoster?");
                    ...
                    //alert(data);
                                            ...
                                            if(data.msg=="success"){
                                                ...
                                                showAlert("success",data.totalOrders + " ePoster confirmed successfully.");
            ...
            <li>
                ...
                echo CHtml::ajaxLink("<i class='fa fa-times-circle-o'></i> Canceled", Yii::app()->createUrl('//admin/eposterList/canceled'), array(
                    'cache' => true,
                    'type' => 'POST',
                    'data' => 'js:{value : $.fn.yiiGridView.getChecked("job-view-data","actionCheck[]")}',
                    "beforeSend" => 'js:function(){
                    ...
                    'success' => 'js:function(data){
                                            ...
                                            if(data.msg=="success"){
                                                ...
                                                jQuery(document).ready(function () {
                UIToastr.init("success",data.totalOrders + " ePoster calceled successfully.");
            });
