...
<?php
        ...
        echo $form->hiddenField($modelImage, 'document_type', array('class' => 'form-control','value'=>$modelImage->document_type));
    ?>
  ...
  <div class="row">
    <div class="col-md-12">
      <?php echo $form->labelEx($modelImage, 'template_type', array('class' => '')); ?>
        ...
        <div class="col-md-12 templateDocument" style="display: none;">
