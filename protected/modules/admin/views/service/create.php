                ...
                <div class="page-head">
                    <div class="container">
                        ...
                        <div class="page-action-buttons"><!-- 
                            ...
                            <a class="btn btn-sm btn-primary" href="<?= $this->createUrl('//admin/service') ?>" title="Service List"> <i class="fa fa-list"></i> Service List</a>
                        </div>
            ...
            <!--end row--><div class="form-group">
                                         ...
                                         <div class="form-group">
                                             <div class="col-md-12">
                                                <?php echo CHtml::label('Categories', 'categories'); ?>
                                                   <?php echo CHtml::dropDownList('categories[]', $data['selectedCategory'], ServiceCategory::model()->dropDown(), array('class' => 'form-control select2', 'multiple' => 'multiple', 'empty' => 'Select Any')); ?>
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <?php echo $form->labelEx($model, 'subscription', array('class' => '')); ?>
                                                
                                                   <?php echo $form->dropDownList($model, 'subscription',array('No'=>'No','Yes'=>'Yes'), array('class' => 'form-control','prompt'=>'Select Any')); ?>
                    ...
                    <tbody id="imageItemBox">
                        ...
                        if (count($data['productsImage']) > 0) {
                            foreach ($data['productsImage'] as $preImage):
                                ...
                                <tr>
                                    <td>
                                        <input type="file" name="ServiceImage[image][]">
                                        <img style="width: 120px;height: 100px;" src="<?php echo Yii::app()->easycode->showOriginalImage($preImage->image,'/product/'); ?>"><input type="hidden" name="ServiceImage[id][]" value="<?php echo $preImage->id ?>">
                                    </td>
                                    <td class="text-right">
                                        <input type="text" name="ServiceImage[sort_order][]" class="form-control" value="<?php echo $preImage->sort_order ?>">
                                    </td>
                                    <td class="text-left">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <input type="text" name="ServiceImage[sort_order][]" class="form-control">
                            </td>
                            <td class="text-left">
                    ...
                    <tbody id="downloadItemBox">
                        ...
                        if (count($data['productsDownload']) > 0) {
                            foreach ($data['productsDownload'] as $preImage):
                                ...
                                <tr>
                                    <td>
                                        <input type="file" name="ServiceDownload[image][]">
                                        <img style="width: 120px;height: 100px;" src="<?php echo Yii::app()->easycode->showOriginalImage($preImage->image,'/product/'); ?>"><input type="hidden" name="ServiceDownload[id][]" value="<?php echo $preImage->id ?>">
                                    </td>
                                    <td class="text-right">
                                        <input type="text" name="ServiceDownload[sort_order][]" class="form-control" value="<?php echo $preImage->sort_order ?>">
                                    </td>
                                    <td class="text-left">
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <input type="text" name="ServiceDownload[sort_order][]" class="form-control">
                            </td>
                            <td class="text-left">
                                <button data-original-title="Remove" type="button" data-toggle="tooltip" onclick="$(this).parent().parent().remove();" title="Remove" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>
                            </td>
...
<script>
    ...
    $('body').on('click', '.del-image-db', function () {
        ...
        if (confirm('Are you sure to detele?')) {
            ...
            if (dataId.trim() !== '') {
                $.post("<?php echo Yii::app()->createUrl('//admin/service/delImage') ?>", {delId: dataId}, function (data) {
                    if (data == '1') {
    ...
    function addDownloadRow(idtoappend) {
        var row = '<tr><td><input type="file" name="ServiceDownload[image][]"></td><td class="text-right"><input type="text" class="form-control" name="ServiceDownload[sort_order][]"></td><td class="text-left"><button class="btn btn-danger" title="Remove" onclick="$(this).parent().parent().remove();" data-toggle="tooltip" type="button" data-original-title="Remove"><i class="fa fa-minus-circle"></i></button></td></tr>';
        $(idtoappend).append(row);
    }
    ...
    $('body').on('click', '.del-download-db', function () {
        ...
        if (confirm('Are you sure to detele?')) {
            var dataId = $this.attr('data-id');
            if (dataId.trim() !== '') {
                $.post("<?php echo Yii::app()->createUrl('//admin/service/delDownload') ?>", {delId: dataId}, function (data) {
                    if (data == '1') {
                        $this.parent().parent().remove();
                    }
                });
