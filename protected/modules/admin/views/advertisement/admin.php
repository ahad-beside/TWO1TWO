                    ...
                    <div class="container">
                        ...
                        <div class="page-action-buttons">
                           <!-- <a class="btn btn-sm btn-primary" href="javascript:void(0)" onclick="javascript:$('.grid-search-portlet').toggle('slow')" title="Search"> <i class="fa fa-search"></i> Search</a> -->
                            <a class="btn btn-sm btn-primary" href="<?= $this->createUrl('//admin/advertisement/create') ?>" title="Create Advertisement"> <i class="fa fa-plus"></i> Create Advertisement</a>
                        </div>
...
//                ),
                            ...
                            'name' => 'image',
                            'filter' => false,
                            'value' => 'Advertisement::model()->getProductImage($data->image)',
                            'type' => 'raw',
                        ),
                                                array(
                                                    'name' => 'position',
