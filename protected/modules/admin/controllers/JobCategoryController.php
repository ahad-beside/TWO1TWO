...
class JobCategoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['JobCategory']))
		{
			...
			$model->slug = Yii::app()->easycode->makeSlug('JobCategory',$model->name);
			if($model->save()){
        ...
        $model->sort_order = Yii::app()->easycode->getLastSortingNumber('JobCategory', 'sort_order');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['JobCategory']))
		{
			...
			$model->slug = Yii::app()->easycode->makeSlug('JobCategory',$model->name);
			if($model->save()){
				Yii::app()->user->setFlash('success', "Success: Category updated successfully");
				$this->redirect(array('admin'));
			}else{
				Yii::app()->user->setFlash('warning', "Warning: Please check the form carefully for errors!");
			}
